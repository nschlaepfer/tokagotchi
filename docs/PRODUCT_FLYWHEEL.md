...
- GitHub Actions Docker proof passes on `main`.
- The latest proof artifact must report `truth_grounding_passed: true`, a clean git tree, 20/20 executable task references passing, 5/5 optimization benchmarks passing, and 0 integration-test failures.
